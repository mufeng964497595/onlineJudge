 ...
 * 处理C++语言提交的代码
 */
public class DealSubmitCodeInCpp extends DealSubmitCode {
	private final String sourceFileName = "Main.cpp";
	private final String outFileName = "Main";

	public DealSubmitCodeInCpp(String cid, String pno, String code, long runId, int timeLimit, int memLimit) {
	...
	protected ArrayList<String> getCompileCommands() {
		...
		compileCommands.add(String.format("cd %s&&g++ %s -o %s", codeDir, sourceFileName, outFileName));
