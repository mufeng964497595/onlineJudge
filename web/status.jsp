...
<html>
	<head>
		...
		<%
			...
			long totalPage = GetInfoFromDatabaseDao.getStatusTotalPage(cid, pno, username, result, language, isCidCorrect,isShowContest);
...
<!-- 		                            <option value="3">JAVA</option> -->
					...
					<tbody>
						...
						<tr class="<%=className%>">
							...
							<td><%switch(bean.getResult()){case "1":
									out.print("<span class='accept'>"+results[Integer.parseInt(bean.getResult())]+"</span>");
								break;case "7": case "8":
									//TODO reSubmit
									out.print("<span class='grey'>"+results[Integer.parseInt(bean.getResult())]+"</span>");
								break;default:
...
<%-- 							<td><%=bean.getMem()%></td> --%>
							...
							<td><%if( isAdmin || bean.getUsername().equals(username) || (bean.getShared().equals("1") && isEnd) ){%>
